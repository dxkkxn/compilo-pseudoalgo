...
{
       0,    70,    70,    76,    78,    80,    82,    86,    87,    88,
      89,    93,    94,    97,    98,   102,   103,   104,   105,   106,
     107,   108,   109,   110,   111,   112,   113,   114,   115,   116,
     117,   118,   119,   120,   121,   124,   125,   128,   129,   131,
     133,   134,   135,   136,   137
};
#endif
...
static const char *const yytname[] =
{
  ...
  "\">=\"", "\"<=\"", "\"!=\"", "\"OU\"", "\"ET\"", "\"NON\"", "ID", "NB",
  "'<'", "'>'", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "OP_UN", "'['",
  "']'", "'('", "')'", "$accept", "PROG", "VAR_ENTREE", "LIST_ID",
  "SAUT_LIGNES", "INSTS", "EXP", "INST", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  case 2:
#line 74 "parser.y"
                       {free((yyvsp[-8].iden)); main_codegen((yyvsp[-2].el_list));}
#line 1470 "parser.c"
    break;
...
#line 76 "parser.y"
                            {ts_ajouter_id(yylval.iden, 1, false);
                             codegen_entree(yylval.iden); free((yyvsp[0].iden));}
#line 1477 "parser.c"
    break;
...
#line 78 "parser.y"
                                     {ts_ajouter_id((yyvsp[-3].iden), (yyvsp[-1].nb), true);
                                      codegen_entree((yyvsp[-3].iden)); free((yyvsp[-3].iden));}
#line 1484 "parser.c"
    break;
...
#line 80 "parser.y"
                 {ts_ajouter_id((yyvsp[0].iden), 1, false);
                  codegen_entree((yyvsp[0].iden)); free((yyvsp[0].iden));}
#line 1491 "parser.c"
    break;
...
#line 1498 "parser.c"
  ...
  case 7:
#line 86 "parser.y"
                      { ts_ajouter_id((yyvsp[0].iden), 1, false); free((yyvsp[0].iden));}
#line 1504 "parser.c"
    break;

  case 8:
#line 87 "parser.y"
                              {ts_ajouter_id((yyvsp[-3].iden), (yyvsp[-1].nb), true); free((yyvsp[-3].iden));}
#line 1510 "parser.c"
    break;
...
#line 1540 "parser.c"
  ...
  case 16:
#line 103 "parser.y"
              {(yyval.noeud) = creer_feuilleID(yylval.iden); free(yylval.iden); }
#line 1546 "parser.c"
    break;

  case 17:
#line 104 "parser.y"
                   { (yyval.noeud) = creer_feuilleIDTab((yyvsp[-3].iden), (yyvsp[-1].noeud)); free((yyvsp[-3].iden));}
#line 1552 "parser.c"
    break;
...
#line 125 "parser.y"
        ...
        (yyval.noeud) = creer_noeudAff(creer_feuilleID((yyvsp[-3].iden)), (yyvsp[-1].noeud)); free((yyvsp[-3].iden));}
#line 1668 "parser.c"
    break;
...
#line 1681 "parser.c"
  ...
  case 39:
#line 132 "parser.y"
     { (yyval.noeud) = creer_noeudAffTab((yyvsp[-6].iden), (yyvsp[-4].noeud), (yyvsp[-1].noeud)); free((yyvsp[-6].iden));}
#line 1687 "parser.c"
    break;
